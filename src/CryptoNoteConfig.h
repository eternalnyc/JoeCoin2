...
#define FORCE_MIXIN_SIZE                                     6 // Every tx on the chain is required to have a mixin size of 6
...
const uint64_t MINIMUM_FEE                                   = UINT64_C(10000000);    // pow(10, 6)
const uint64_t DEFAULT_DUST_THRESHOLD                        = UINT64_C(10000000);    // pow(10, 6)
...
const char     CRYPTONOTE_NAME[]                             = “joeCoin“;
...
const int      P2P_DEFAULT_PORT                              =  15661; // P2P blockchain port
const int      RPC_DEFAULT_PORT                              =  15662; // JSON RPC port
...
const char* const SEED_NODES[] = {
  "159.203.103.120:15661” // CHANGE YOUR FUCKIN SEED NODES
...
const CheckpointData CHECKPOINTS[] = {
  {0,  "block-tx-hash"}, // Put block checkpoints here like this: Block height, then block tx hash
};
} // CryptoNote
